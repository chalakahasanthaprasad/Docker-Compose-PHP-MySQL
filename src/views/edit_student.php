...
if (!isset($_SESSION['loggedin']) || $_SESSION['loggedin'] !== true) {
    ...
    if ($now > $_SESSION['expire']) {
        ...
        <form method="post" id="updateStudentForm" action="../controllers/StudentController.php">
            <div id="wrapper">
                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    ...
                                    <input type="hidden" name="std_index" value="<?php echo $student['std_index']; ?>">
                                    <label name="index" id="index"><strong>Index No :
                                            <?php echo $student['std_index']; ?></strong></label>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-10">
                                        <div class="form-group">
                                            <input type="hidden" name="form_id" value="updateStudentForm">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4">
                                                <select name="title" id="title" class="form-control">
                                                    ...
                                                    <option value="Mr" <?php echo $student['title'] == 'Mr' ? 'selected' : ''; ?>>
                                                        Mr</option>
                                ...
                                <div class="row">
                                    <div class="col-lg-10">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-6">
                                                <input class="form-control" type="tel" name="parent_mobile" required="required"
                                                    maxlength="10" pattern="[0-9]{10}"
