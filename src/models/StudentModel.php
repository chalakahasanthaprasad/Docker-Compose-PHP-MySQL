...
class StudentModel
{
    ...
    public function updateStudent($std_id, $index, $std_tcenter, $std_title, $std_name, $std_gender, $std_dob, $std_language, $std_mobile, $std_email, $std_parent_mobile, $std_city, $std_address, $update)
    {
        ...
        $stmt->bind_param('issssssssissi', $std_tcenter, $std_title, $std_name, $std_gender, $std_dob, $std_language, $std_mobile, $std_email, $std_parent_mobile, $std_city, $std_address, $update, $std_id); // 's' for string, 'i' for integer
        $stmt->execute();
        $stmt->close();
    }
